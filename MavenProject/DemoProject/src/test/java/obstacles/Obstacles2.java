...
public class Obstacles2 
{
		...
		public void Obstacle17_halfway() throws InterruptedException                                 //erreor
	...
	public void Obstacle28_BubbleSort1() throws InterruptedException {                            //error
      ...
      driver.quit();
		...
		public void Obstacle32_Changedcell() {                                                      //   error
		    ...
		    try {
		        ...
		        // Click the link in the table cell
		        WebElement tableCellLink = driver.findElement(By.xpath("/html/body/div[2]/table/tbody/tr[9]/td[9]/a"));
		        tableCellLink.click();
		        ...
		        // Skip the first row as it's usually the header row
		        int numRows = rows.size();
		        List<WebElement> columns = rows.get(0).findElements(By.tagName("td"));
		        int numColumns = columns.size();
		        if (numColumns == 0) {
		            throw new IllegalStateException("No columns found in the table.");
		        }
		        
		        // Generate random row and column indices
		        Random random = new Random();
		        int randomRow = random.nextInt(numRows - 1) + 1; // Skip the header row
		        ...
		        // Click the random cell and enter new value
		        randomCell.click();
		        randomCell.sendKeys("asddsa"); // Replace "aannnuu" with the desired new value
		        
		        // Store the changed value
		        String changedValue = "asddsa"; // Replace "annnuuu" with the actual changed value
		        
		        WebElement rowInput = driver.findElement(By.id("rowNumber"));
		        WebElement columnInput = driver.findElement(By.id("columnNumber"));
		        WebElement originalValueInput = driver.findElement(By.id("originalValue"));
		        WebElement changedValueInput = driver.findElement(By.id("changedValue"));
		        
		        // Fill the input fields with appropriate values
		        rowInput.sendKeys(String.valueOf(randomRow));
		        columnInput.sendKeys(String.valueOf(randomColumn));
		        originalValueInput.sendKeys(originalValue);
		        changedValueInput.sendKeys(changedValue);
		        
		        // Submit the form
		        driver.findElement(By.id("submit")).click();
		    } catch (Exception e) {
		        // Handle any exceptions that occurred during the test execution
		        e.printStackTrace();
		    } finally {
		        // Make sure to close the WebDriver and release resources
		        if (driver != null) {
		           // driver.quit();
		        }
		    }
	...
	public void Obstacle_GetSuesNumber(){                                                              //error
